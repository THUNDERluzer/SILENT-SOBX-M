...
console.log("CONNECTING SILENT-panda-MD BOT🧬...");
...
console.log('Panda-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
>

*╭⊱✫🔮 Panda-MD 🔮✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *☠️-MD*
...
const pushname = mek.pushName || 'Hashan'
...
if(senderNumber.includes("94787250956")){
if(isReact) return
m.react("🦋")
}
//==========================public react===============//
